...
class MainRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: MainVieModel, position: Int) {
        ...
        if (viewType == Constants.SCROLL_TYPE)
            ...
            holder.searchFragmentnumberOfPiecesTextView?.text = "pcs ${model.quantityOfItem.toString()}"

            holder.searchFragmentPriceTExtView?.text ="${mainActivity.getString(R.string.Rs)} ${model.realTimeMrp}"
